                            ...
                            <div class="big-video">
                                <?php if (!empty($article[0])) { ?>
                                    <div id="video-lag" class="owl-carousel owl-theme">
                                        <div class="item-video" data-merge="<?php echo $article[0]->id; ?>">
                                            <a class="owl-video" href="<?php echo $article[0]->hyperlink; ?>"></a>
                                        </div>
                                    </div>
                                    <script>
                                    ...
                                    <h2 class="main-title"><?php echo $article[0]->title; ?></h2>
                                    <div class="row row-5">
                                        <div class="col-6 col-sm-3 padding-5">
                                            <p class="views"><?php echo $article[0]->views . ' ' . rear('views'); ?>
                                                | <?php echo date('d/m/Y', strtotime($article[0]->date_create)); ?></p>
                                        </div>
                                ...
                                <?php foreach ($article as $art) { ?>
                                    <div class="col-sm-4 padding-5">
                                        <div class="news-inner inner-video">
                                            ...
                                            <?php if ($art->id == $article[0]->id) { ?>
                                                <span class="play-now"><?php echo rear('run_video');?></span>
                                            <?php } else{ ?>
                                                <a href="<?php echo base_url($art->alias); ?>"
