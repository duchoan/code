    ...
    <div class="container">
        <div class="post-page">
            <div class="content-post-info-user">
                <div class="icon-cart">
                    <div class="cart-active" style="width: 10%">
                        <span></span>
                    </div>
                </div>
                <h1 class="title-head cat">
                    <a href="<?php echo base_url($GLOBALS['alias_cart']); ?>"
                       title="Giỏ hàng của bạn"><?php echo rear('name_cart'); ?></a>
                </h1>
                <div class="form-cart">
                                ...
                                <table class="table">
                                    ...
                                    <tr class="number-total">
                                        <td colspan="3">
                                            ...
                                            <button onclick="<?php if(!empty($procate)){ ?>window.location.href='<?php echo base_url($procate->$GLOBALS['alias']); } ?>'"
                                                    type="button"
                                                    title="<?php echo rear('next_buy');?>" class="btn btn-danger btn-next-buy">
