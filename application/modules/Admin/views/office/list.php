    ...
    <ul>
        <?php if(Check_per_action($table,$iduser,1)){?>
            <li class="option-item"><a class="option-add"
                                       href="<?php echo base_url(); ?>admin-direct/add?table=<?php echo $table; ?>"><span>Tạo văn phòng mới</span></a>
            </li>
        <?php }?>
        ...
        <li class="option-item item-list-status"><a
            ...
            <ul class="ul-list cookie-name" cookie_name="content_list_office" catid="allsearch_text"
                ...
                <li><span class="tick-active">Tên văn phòng</span></li>
                <li><span class="tick-active">Địa chỉ</span></li>
            </ul>
        </li>
            ...
            <?php foreach ($object_item as $obj) { ?>
                <tr>
                    ...
                    <td class="text-center">
                        <?php if (!empty($obj->address)) { echo $obj->address; ?>
