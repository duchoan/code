...
<?php } ?>
<form method="post" action="<?php echo base_url(); ?>admin-direct/add?table=town">
                ...
                <div class="row row-input">
                    ...
                    <div class="col-xs-10">
                        <input type="text" name="title_en" class="control-input input-user"
                               value="<?php echo $this->input->post('title_en'); ?>"/>
                    </div>
                </div>
                <?php
                                        ...
                                        <select name="district">
                                            <?php if(!empty($district)){?>
                                                <?php foreach($district as $ct){?>
                                                    <option value="<?php echo $ct->id;?>" <?php if ($this->input->post('district')==$ct->id){echo 'selected="selected"';}?>><?php echo $ct->title;?></option>
                                                <?php }?>
                                            <?php }else{?>
