    ...
    <ul>
        <?php if(Check_per_action($table,$iduser,1)){?>
            <li class="option-item"><a class="option-add"
                                       href="<?php echo base_url(); ?>admin-direct/add?table=<?php echo $table; ?>"><span>Tạo quận huyện mới</span></a>
            </li>
        <?php }?>
        ...
        <li class="option-item item-list-status"><a
            ...
            <ul class="ul-list cookie-name" cookie_name="content_list_district" catid="allsearch_text"
                ...
                <li><span class="tick-active">Tên quận huyện</span></li>
        ...
        <table class="table table-contact table-list">
            ...
            <?php foreach ($object_item as $obj) { ?>
                <tr>
                    ...
                    <td>
                     <?php $city = $this->Common_model->get_one('city',array('id'=>$obj->id_city));
                        if(!empty($city)){echo $city->title ;}
                      ?>
                    </td>
                </tr>
                <!-- end row item-->
