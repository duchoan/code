...
<?php } ?>
<form method="post" action="<?php echo base_url(); ?>admin-direct/edit?table=service&id=<?php echo $item_post->id ;?>">
    ...
    <div class="content-add-item">
        <p class="add-title-top">Cập nhập service</p>
        ...
        <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-1 box-tooltip-img">
                                <span class="image-tooltip ">
                                    <img id="views-image1" class="zoom-image" src="<?php echo $item_post->icon; ?>">
                                </span>
                            </div>
                            <div class="col-xs-3">
                                ...
                                <div class="select-box col-xs-12">
                                    <label>
                                        <select name="position">
                                            <option <?php if($item_post->position=='0'){echo 'selected';}?> value="0">1</option>
                                            <option <?php if($item_post->position=='1'){echo 'selected';}?> value="1">2</option>
                                        </select>
                                    </label>
                                </div>
                            </div>
            ...
            <!-- end -->
            <?php if (!empty($language)) { $intro='excerpt'.$lang->value; ?>
