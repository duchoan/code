...
<div class="menu-option">
    <ul>
        ...
        <li class="option-item item-list-status"><a
            ...
            <ul class="ul-list cookie-name" cookie_name="content_list_service" catid="allsearch_text"
                ...
                <li><span class="tick-active">Tên service</span></li>
                <li><span class="tick-active">Vị trí</span></li>
    ...
    <div class="list-item">
        <table class="table table-contact table-list">
            ...
            <tr>
                ...
                <th style="line-height:35px;">Tên lợi ích</th>
                <th style="line-height:35px;" class="text-center">Vị trí</th>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($object_item as $obj) { ?>
                <tr>
                    ...
                    <td class="text-center">
                        <?php if ($obj->position==0) {echo 'Blue'; }else{echo 'Green';} ?>
                    </td>
                </tr>
                <!-- end row item-->
            <?php } ?>
