...
<?php } ?>
<form method="post" action="<?php echo base_url(); ?>admin-direct/add?table=article">
        ...
        <div class="row">
            <div class="col-xs-12 col-information">
                ...
                <div class="row row-input">
                    ...
                    <div class="col-xs-5">
                        <input name="title_other" type="text" value="" class="control-input input-title"/>
                    </div>
                </div>
                <!-- end row-->
                <?php if (!empty($language)) { ?>
                    <?php foreach ($language as $lang) { ?>
                        <div class="row row-input">
                            ...
                            <div class="col-xs-5">
                                <input name="<?php echo $ali;?>" type="text" value="" class="control-input input-title"/>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
                ...
                <div class="row row-input">
                    ...
                    <div class="col-xs-5">
                        <input name="hyperlink" type="text" value="<?php echo $this->input->post('hyperlink');?>" class="control-input input-title"/>
                    </div>
                </div>
                <!-- end row-->
                <div class="toggle-group">
