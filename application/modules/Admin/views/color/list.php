    ...
    <ul>
        ...
        <li class="option-item item-list-status"><a
            ...
            <ul class="ul-list cookie-name" cookie_name="content_list_price" catid="allsearch_text"
                ...
                <li><span class="tick-active">Mã màu</span></li>
        ...
        <table class="table table-contact table-list">
            ...
            <?php foreach ($object_item as $obj) { ?>
                <tr>
                    ...
                    <td>
                        #<?php echo $obj->value; ?><span style="display:block;width:60px;height:30px;background:#<?php echo $obj->value; ?>;float:right;"></span>
                    </td>
<!--                    <td>-->
<!--                        --><?php //if (!empty($obj->position)) {echo $obj->position;} ?>
<!--                    </td>-->
                </tr>
                <!-- end row item-->
            <?php } ?>
