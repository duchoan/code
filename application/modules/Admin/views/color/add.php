...
<?php } ?>
<form method="post" action="<?php echo base_url(); ?>admin-direct/add?table=color">
    ...
    <div class="content-add-item">
        <p class="add-title-top">Tạo màu sản phẩm mới</p>
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="user-info">
                <div class="row row-input">
                    <div class="col-xs-2">Tên màu<span class="user-error">*</span></div>
                    <div class="col-xs-10">
                ...
                <!-- end row-->
                <div class="row row-input">
                    <div class="col-xs-2">Mã màu<span class="user-error">*</span></div>
                    <div class="col-xs-10">
                        <input  type="text" name="value" class="jscolor control-input input-user"
                               value="<?php echo $this->input->post('value'); ?>"/>
                    </div>
                </div>
                <!-- end row-->
                <div class="row row-input">
