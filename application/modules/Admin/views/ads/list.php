    ...
    <div class="list-item">
        <table class="table table-contact table-list table-hover">
            ...
            <tr>
                ...
                <th style="line-height:35px;">Hình ảnh</th>
                <th style="line-height:35px;">Thể loại</th>
            ...
            <?php $order_id=0; foreach ($object_item as $obj) { ?>
                <tr>
                    ...
                    <td>
                        <img src="<?php echo $obj->image ;?>" alt="" width="80px">
                    </td>
                    <td>
                        <?php if($obj->type==1){echo 'Video';}else if($obj->type==0){echo 'Hình ảnh';}else{echo 'Báo chí';} ?>
                    </td>
