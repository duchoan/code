...
$root .= str_replace('ckeditor/ckfinder/core/connector/php/connector.php',"",$_SERVER['SCRIPT_NAME']);
define('DS', DIRECTORY_SEPARATOR);
$dir=str_replace('ckeditor'.DS.'ckfinder',"",__DIR__);
@session_start();
/*
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => 'upload/',
    'root'         => $dir.'upload/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
